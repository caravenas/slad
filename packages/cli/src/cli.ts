...
pipelineCmd
  ...
  .option("--worktrees", "Aislar cada tarea en su propio git worktree; el resultado queda pendiente de review en la rama de integración (requiere --parallel y HEAD commiteado)")
  .option("--keep-worktrees", "Conservar los worktrees/ramas de la sesión tras el run (debug)")
  .option("--review <runId>", "Inspeccionar un run --worktrees pendiente de review (read-only)")
